...
<!--        <link rel="stylesheet" href="/css/main.css">-->
        ...
        <script type="text/javascript">
            ...
            let foods={}
            let before='/src/rate_star_before.png';
            let after='/src/rate_star_after.png';
            let score=-1;

            async function init() {
                let rating_info=JSON.parse(await $.ajax({type: "POST", url: '/script/rating_info.php', data: {userId: <?php echo $_COOKIE['user_id']?> }}))
                src=JSON.parse(await $.get("/script/rating.php"))
                let inner=''
                ...
                let keys=Object.keys(rating_info_json)
            ...
            function makeDiv() {
                return `
          <div class="list-group-item list-group-item-action py-3 lh-tight justify-content-between" aria-current="true" id="${arguments[0]}">
            <div id="${arguments[0]}_img" style="display: inline-block; margin: auto;">
              <img src="/src/ramen.jpg" height="60" width="60">
            </div>
            <div style="display: inline-block; margin: auto;" class="rating_content" id="${arguments[0]}_content">
              <div class="d-flex w-100" style="font-size: 25px; width: 250px; margin: 0px !important; padding: 0px !important;">
                <span>${arguments[1]}</span>
              </div>
              <div class="col-10 mb-1 small" id="${arguments[0]}_rating" style=" margin: 0px !important; padding: 0px !important;">
                <span class="material-symbols-outlined" onclick="set(0,${arguments[0]})"><img src="/src/rate_star_before.png" height="40" width="40"></span>
                <span class="material-symbols-outlined" onclick="set(1,${arguments[0]})"><img src="/src/rate_star_before.png" height="40" width="40"></span>
                <span class="material-symbols-outlined" onclick="set(2,${arguments[0]})"><img src="/src/rate_star_before.png" height="40" width="40"></span>
                <span class="material-symbols-outlined" onclick="set(3,${arguments[0]})"><img src="/src/rate_star_before.png" height="40" width="40"></span>
                <span class="material-symbols-outlined" onclick="set(4,${arguments[0]})"><img src="/src/rate_star_before.png" height="40" width="40"></span>
              </div>
            </div>
          </div>`
            }
            function clear() {
                for(let i=0;i<5;i++) {
                    let rate=arguments[0][i]
                    rate.children[0].src=before
                }
            }
            function set() {
                let post_json={}
                score=arguments[0]+1
                post_json.foodId=arguments[1]
                post_json.foodName=foods[arguments[1]]
                post_json.rating=score

                post_json.userId=<?php echo $_COOKIE['user_id'] ?>


                $.ajax({
                    url: "/script/rating_insert.php",
                    method: "POST",
                    data: post_json
                })
                    .done((data)=>{
                ...
                let rating_list=document.getElementById(arguments[1]+'_rating').children
                clear(rating_list)
                for(let i=0;i<=arguments[0];i++) {
                    let rate=rating_list[i]
                    rate.children[0].src=after
                }
            }
            function set_init() {
                score=arguments[0]+1
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <main role="main" class="inner cover" id="rating" style="margin-top: 20px;">
        ...
        <div class="overflow-hidden p-3 bg-light" style="max-width: 1000px; width: 500px; max-height: 700px; overflow-y:scroll;" id="scroll_layout">
        </div>
    </main>
